...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$rootDir'; ./scripts/windows/start_backend.ps1"

# Wait 2 seconds for backend to bind
Start-Sleep -Seconds 2

# Launch Frontend in new window
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$rootDir'; ./scripts/windows/start_frontend.ps1"
